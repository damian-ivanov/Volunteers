...
namespace Volunteers.Migrations
{
    ...
    [Migration("20210730154836_UserProjectJoinTable")]
    partial class UserProjectJoinTable
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Volunteers.Data.Models.ProjectsUsers", b =>
                {
                    b.Property<string>("ProjectId")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("BadgeUser", b =>
                {
                    b.HasOne("Volunteers.Data.Models.Badge", null)
                        .WithMany()
            ...
            modelBuilder.Entity("Volunteers.Data.Models.Project", b =>
                {
                    b.HasOne("Volunteers.Data.Models.Category", "Category")
                        .WithMany("Projects")
